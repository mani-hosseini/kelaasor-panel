...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div data-slot="card" className={cn("surface-panel flex flex-col text-card-foreground", className)} {...props} />
  );
}
...
function CardTitle({ className, ...props }: React.ComponentProps<"h3">) {
  return <h3 data-slot="card-title" className={cn("text-base font-bold leading-none", className)} {...props} />;
}
